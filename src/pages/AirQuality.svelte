      ...
      <div class="w-full flex flex-col items-center gap-4">
        ...
        {#if airQualityData}
          <div class="w-full max-w-4xl">
            <canvas id="airQualityChart" height="400" width="800"></canvas>
          </div>
          ...
          <div class="mt-6 w-full overflow-auto max-h-[500px]">
            <table class="min-w-full bg-white rounded-lg w-full">
              <thead class="bg-gray-200">
                <tr>
                  <th class="py-2 px-4 bg-gray-600 text-white">Date</th>
                  <th class="py-2 px-4 bg-gray-600 text-white">European AQI</th>
                  <th class="py-2 px-4 bg-gray-600 text-white"
              ...
              <tbody>
                {#each airQualityData.hourly.time as time, i}
                  <tr class="border-t">
                    <td class="py-2 px-4 text-cent bg-gray-600 text-white"
                      >{time}</td
                    >
